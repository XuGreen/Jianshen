...
@interface ApplyPersonViewController ()<UITextViewDelegate>
...
@implementation ApplyPersonViewController
...
-(void)setNav{
    ...
    self.navigationItem.title=@"适用人群";
...
-(void)CompleteButton:(UIButton *)sender{
    [self.delegate  ApplyPersonWithName:_inputView.text];
    [self.navigationController popViewControllerAnimated:YES];
}
