...
#import "MeOrderMangerViewController.h"
#import "MeAllOrderViewController.h"
#import "MeNoPayViewController.h"
#import "MeStayServerViewController.h"
#import "MeUnderwayViewController.h"
#import "MeStayEvaluateViewController.h"
#import "MeCancelViewController.h"
#import "TitleButton.h"

@interface MeOrderMangerViewController ()<UIScrollViewDelegate>
//当前选中的标题按钮
...
@implementation MeOrderMangerViewController
...
- (void)setupChildViewControllers{
    MeAllOrderViewController *all=[[MeAllOrderViewController alloc]init];
    [self addChildViewController:all];
    
    MeNoPayViewController *NoPay=[[MeNoPayViewController alloc]init];
    [self addChildViewController:NoPay];
    
    MeStayServerViewController *StayServer=[[MeStayServerViewController alloc]init];
    [self addChildViewController:StayServer];
    
    MeUnderwayViewController *UnderWay=[[MeUnderwayViewController alloc]init];
    [self addChildViewController:UnderWay];
    
    MeStayEvaluateViewController *Evaluate=[[MeStayEvaluateViewController alloc]init];
    [self addChildViewController:Evaluate];
    
    MeCancelViewController *cancel=[[MeCancelViewController alloc]init];
