...
@interface ImageGroupView()<HZPhotoBrowserDelegate>
@end
...
- (void)setPhotoItemArray:(NSArray *)photoItemArray
{
    ...
    [photoItemArray enumerateObjectsUsingBlock:^(PhotoModel *obj, NSUInteger idx, BOOL *stop) {
        ...
        [btn.imageView sd_setImageWithURL:[NSURL URLWithString:obj.thumbnail_pic]  placeholderImage:[UIImage imageNamed:@"background"]];
