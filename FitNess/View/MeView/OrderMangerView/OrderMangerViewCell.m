...
- (void)initUI{
    ...
    [serverView addSubview:self.OrderBtn];
...
- (UILabel *)userName{
    if (!_userName) {
        ...
        UIImageView *userImage=[MyView Image:@"personal1" corner:0 rect:   CGRectMake(15, hight(24), wight(33), hight(33))];
        [OrderMangerView addSubview:userImage];
       
        _userName=[MyView label:@"浩仔" tColor: [tools colorWithHex:0x333333]font: [UIFont systemFontOfSize:15] rect: CGRectMake( userImage.xmg_right+wight(16), hight(24), wight(300), hight(40))];
    }
    return _userName;
}
- (UILabel *)statusLabel{
    if (!_statusLabel) {
        ...
        _statusLabel=[MyView label:@"待付款" tColor: [tools colorWithHex:0xFFB81F]font: [UIFont systemFontOfSize:14] rect: CGRectMake( SCREENWIDTH-wight(100)-15, hight(24), wight(100), hight(40))];
    }
    return _statusLabel;
}
...
- (UIButton *)OrderBtn{
    if (!_OrderBtn) {
        ...
        _OrderBtn=[MyView ImageButton:@"button-bg" text:@"查看预约" tColor: [UIColor whiteColor] cornet:20 rect:CGRectMake(SCREENWIDTH-wight(140)-15, hight(20), wight(140), hight(50))];
